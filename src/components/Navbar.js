...
class Navbar extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      showCart: false,
      /* Creating a reference to the currency dropdown. */
  ...
  render() {
    ...
    const { showCurrencyTab, currencyDropdownRef, showCart, cartDropdownRef } =
      this.state;
    ...
    const NavBarLinks = categories.map((item, index) => (
      <div className="category-link" key={index}>
        <NavLink
          ...
          to={`/${item}`}
          className={({ isActive }) => `text-category 
                            ${
                              isActive ||
                              (index != null && index === selectedNav)
                                ? "nav-select"
                                : ""
                            }`}
        >
      ...
      <div ref={currencyDropdownRef} className="currency-container">
        <div
          ...
          onClick={(e) => {
            ...
            this.listenToOutsideClick("showCurrencyTab", currencyDropdownRef);
          }}
        >
